...
参考 [Java序列化之排除被序列化字段(transient/静态变量](https://blog.csdn.net/lisulong1/article/details/52269262)
...
transient 关键字的作用是：阻止实例中那些用此关键字修饰的的变量序列化；当对象被反序列化 时，被 transient 修饰的变量值不会被持久化和恢复。transient 只能修饰变量，不能修饰类和方 法。
